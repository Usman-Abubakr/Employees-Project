...
public interface SQLQueries {
    ...
    String SELECT_EMPLOYEES_IN_DEPARTMENT_WITHIN_DATES = "SELECT e.* FROM employees.employees e INNER JOIN employees.dept_emp de ON e.emp_no = de.emp_no WHERE de.dept_no = ? AND de.from_date >= ? AND de.to_date <= ?";
}
